/* Generated code for Python module 'win32'
...
/* The "module_win32" is a Python object pointer of module type.
 *
...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("win32"));
...
function_impl_code functable_win32[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_win32;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_win32) || offset < 0) {
...
PyObject *modulecode_win32(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("win32");
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("win32: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("win32: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("win32: Calling createModuleCodeObjects().\n");
#endif
...
#elif 1
        PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_win32, (Nuitka_StringObject *)const_str_plain___name__);
...
#if PYTHON_VERSION >= 0x300
    UPDATE_STRING_DICT0(moduledict_win32, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_win32, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_win32);
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_win32, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_win32, (Nuitka_StringObject *)mod_consts[8], tmp_assign_source_1);
    }

    // Report to PGO about leaving the module without error.
    PGO_onModuleExit("win32", false);

    Py_INCREF(module_win32);
    return module_win32;
